...
function getPages(callback) {
  ...
  console.log("starting getPages");
    ...
    var sheetURL = "https://docs.google.com/spreadsheets/d/1x-7ms5fDNzW2Ah9AXylV0ERWh4O-YlwVpguptmWlWbU/edit?usp=sharing#gid=0";
    var pages = [];
    $('#sheetrock').sheetrock({
        url: sheetURL,
        query: "select *",
...
function createCard(i,page) {
  ...
  console.log("about to create card.");
    ...
    var rowString = '<a href="'+filename+'">';
    rowString += '<div class="card">';
    rowString += '<img class="card-img-top" src="images/cards/' + page.image + '.jpg" alt="Essay image">';
