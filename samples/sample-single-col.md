...
{% include figure.html class="img-right" width="33%" caption="Perry building" src="/images/perry-building.jpg" %}
...
```
{%raw%}{% include figure.html class="img-right" width="33%" caption="Perry building" src="/images/perry-building.jpg" %}{%endraw%}
```
...
{% include figure.html class="img-center" width="100%" src="/images/church.jpg" caption="Here is your caption. Isn't it nice?"%}

To achieve the above full-width (but not jumbotron) image, use:
{%raw%}
```
{% include figure.html class="img-center" width="100%" src="/images/church.jpg" %}
```
{%endraw%}
...
{% include figure.html class="img-left" width="50%" src="/images/perry-building.jpg" caption="Perry Building" %}
...
{% include juxtapose.html image1="/images/campus-plan-cobb.jpg" image2="/images/campus-plan-rippey.jpg" %}

```
{%raw%}{% include juxtapose.html image1="/images/campus-plan-cobb.jpg" image2="/images/campus-plan-rippey.jpg" %}{%endraw%}
```
